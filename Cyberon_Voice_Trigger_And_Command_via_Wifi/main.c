...
TaskHandle_t vtrigger_task_handle;
...
int main(void)
{
    ...
    xTaskCreate(vtrigger_task, "vtrigger task", UDP_CLIENT_TASK_STACK_SIZE, NULL,
                UDP_CLIENT_TASK_PRIORITY, &vtrigger_task_handle);
